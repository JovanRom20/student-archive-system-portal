...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        /* Form & Button Styles */
        .forgot-form { width: 100%; display: flex; flex-direction: column; gap: 15px; }
        
        .input-group input {
            width: 100%; padding: 12px 15px; border: 1px solid #b3b3b3;
            border-radius: 6px; font-size: 14px; outline: none; transition: border 0.3s;
        }
        .input-group input:focus { border-color: #2ea3f2; }
        ...
        /* Footer Links */
        .back-link {
            text-align: center; font-size: 12px; color: #555; margin-top: 25px;
        }
        .back-link a { color: #2ea3f2; text-decoration: none; }
        .back-link a:hover { text-decoration: underline; }

        .copyright {
            margin-top: 30px; font-size: 11px; color: #777; text-align: center; width: 100%;
        }
...
<body>
    ...
    <main class="hero">
        ...
        <div class="forgot-card">
            ...
            <img src="images/resetPasswordIcon.jpeg" class="reset-icon" alt="Reset Password">
            
            <div class="reset-heading">Reset Your Password</div>
            <div class="reset-subtext">
