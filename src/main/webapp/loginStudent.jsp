...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        /* Footer Links */
        .card-footer { margin-top: 20px; font-size: 12px; color: #555; text-align: center; width: 100%; }
        .card-footer a { color: #00aaff; text-decoration: none; font-weight: 600; }
        .card-footer a:hover { text-decoration: underline; }
        .copyright { margin-top: 20px; font-size: 10px; color: #999; text-align: center; }
        /* === DROPDOWN MENU === */
        .auth-container {
            position: relative;
    ...
    <main class="hero">
        ...
        <div class="login-card">
           <div class = "login-header">
            <img src="images/student.jpeg" class="login_logo" alt="LogStudentIcon"> 
                Login your Account
            </div>
            ...
            <a href="login.jsp" class="switch-login">Switch to Admin Login</a>
